...
import { Button, Header, Grid, Icon, Card, Image } from 'semantic-ui-react'
        ...
        if (this.props.feed) {
            ...
            return (
                <Card fluid>
                    ...
                    {showSnapshot ? this.renderSnapshot() : this.renderVedio()}
                    <Card.Content >
                        <Grid columns={4}>
                            {showSnapshot ? this.vedioButton() : this.snapshotButton()}
                            <Grid.Column className="center aligned">
