...
export class Images extends React.Component {
    ...
    loadImages(Id) {
        ...
        $.ajax({
            url: 'http://localhost:60290profile/profile/getEmployerProfileImage/?id=' + Id,
            headers: {
            ...
            success: function (res) {
                ...
                if (res.employerProfile.length > 0) {
                    for (var i = 0; i < res.employerProfile.length; i++) {
                        imageSrcArr.push("http://localhost:60290profile/profile/getEmployerProfileImages/?Id=" + res.employerProfile[i].fileName);
    ...
    fileUploadHandler(Id) {
        ...
        $.ajax({
            url: 'http://localhost:60290profile/profile/addEmployerProfileImages',
            headers: {
                'Authorization': 'Bearer ' + cookies
            },
            type: "POST",
